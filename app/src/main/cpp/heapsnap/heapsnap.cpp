...
#if (PLATFORM_SDK_VERSION<29)
extern "C" void debug_get_malloc_leak_info(uint8_t** info, size_t* overallSize,
...
{
//#if (PLATFORM_SDK_VERSION<29)
//    debug_get_malloc_leak_info(&leak_info->buffer, &leak_info->overall_size, &leak_info->info_size,
...
{
//#if (PLATFORM_SDK_VERSION<29)
//    debug_free_malloc_leak_info(info->buffer);
//#else
...
//#endif
    ...
    info_log("leak_info ,heap to file: %d ,\n", leak_info.backtrace_size);
...
extern "C" void __attribute__((constructor)) prepare()
{
    ...
    LOGE("Heap Snap Version 1.0,prepare\n");
    heapsnap_init();
}
